			...
			<div className='relative z-10 min-h-screen flex flex-col'>
					...
					<div className='max-w-7xl mx-auto'>
						...
						<div className='text-center mb-6'>
							<div className='flex items-center justify-center'>
								<img
									src='https://image.s10.sfmc-content.com/lib/fe2b1171706405797d1375/m/1/2fb6e6f2-244e-41a0-b20a-9049947429c9.png'
									alt='Logo'
									className='w-12 mr-2'
								/>
							...
							<p className='text-white/90 text-sm md:text-base font-light max-w-2xl mx-auto drop-shadow-lg mt-2'>
								Generate professional, brandable domain names
								instantly
							</p>
										...
										<div className='ml-2'>
											...
											{error.includes("credentials") && (
												<p className='text-xs mt-2 text-white/70'>
													💡 Tip: Make sure your .env
													file in the backend folder
													contains all required API
													credentials.
												</p>
											)}
										</div>
				...
				<footer className='relative z-10 py-4 px-4 text-center glass-light border-t border-white/10'>
					<p className='text-white/90 text-xs font-medium'>
						...
						by <span className='text-white font-bold'>Chandu</span>
					</p>
				</footer>
			</div>
		</div>
